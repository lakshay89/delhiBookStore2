        ...
        <div className="bg-white rounded-xl shadow-lg p-8 border border-gray-300">
          ...
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  required
                />
                <Lock className="absolute right-3 top-1/2 -translate-y-1/2 blue-color h-5 w-5" />
              </div>
            </div>
            ...
            <button
              type="submit"
              disabled={loading}
              className={`w-full purple-btn cursor-pointer flex justify-center items-center py-3 rounded-lg font-semibold text-white bg-purple-700 hover:bg-purple-800 transition ${
