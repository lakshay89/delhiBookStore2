...
import stylebanner from "../../app/Images/DBS/BOOKSTOREBANNER.jpg";
...
import SignUpPage from "@/components/SEO/SignSEo";
import { signupUser } from "@/app/redux/features/auth/loginSlice";
...
const Page = () => {
  ...
  const handleEmailVerification = async () => {
    ...
    try {
      const response = await axiosInstance.post("/auth/send-otp-to-user", {
        email,
        fullName,
      });
                ...
                <div className="flex items-start" key={index}>
                  <div className="flex-shrink-0 mt-1">
                    <div className="h-5 w-5 rounded-full bg-purple-100 flex items-center justify-center">
                      <span className="yellow-clr text-xs">✓</span>
                    </div>
                  </div>
                  <div className="ml-3">
            ...
            <form onSubmit={handleSignup}>
              <div className="space-y-5">
                ...
                <div>
                  ...
                  <div className="relative">
                    <input
                      ...
                      required
                    />
                    <User className="absolute right-3 top-1/2 -translate-y-1/2 blue-color h-5 w-5" />
                  </div>
                </div>
                ...
                <div className="space-y-4">
                  ...
                  <div>
                    ...
                    <div className="relative">
                      <input
                        ...
                        required
                      />
                      <Mail className="absolute right-3 top-1/2 -translate-y-1/2 text-gray-700 h-5 w-5" />
                    </div>
                  </div>
                  ...
                  {email && !showOtpBox && (
                    <button
                      ...
                      className="px-4 py-2 bg-[#02547d] cursor-pointer text-white rounded-lg hover:bg-[#000000] transition"
                    >
                      Verify Email
                    </button>
                  )}
                  ...
                  {showOtpBox && (
                    <div className="space-y-2">
                      ...
                      <input
                        ...
                        className="pl-3 py-3 w-full border border-gray-300 rounded-lg duration-200"
                ...
                <div>
                  ...
                  <div className="relative">
                    ...
                    <button
                      ...
                      className="absolute cursor-pointer right-3 top-1/2 -translate-y-1/2 blue-color hover:text-gray-600"
                    >
                      {showPassword ? (
                ...
                <button
                  type="submit"
                  disabled={loading}
                  className="w-full black-btn cursor-pointer"
                >
                  {loading ? (
                ...
                <p className="text-sm text-gray-600 text-center mt-2">
                  ...
                  <Link
                    href="/pages/login"
                    className="yellow-clr hover:underline font-medium"
                  >
                    Sign In
                  </Link>
                </p>
