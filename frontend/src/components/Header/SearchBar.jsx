...
import image1 from "../../app/Images/DBS/1.jpg";
...
export default function ProductSearchBar() {
  ...
  return (
    ...
    >
      <div className="flex items-center bg-gray-200 rounded-md border-1 border-gray-400 overflow-hidden">
        <input
          type="text"
        ...
        />
        <button className="px-4 py-2 text-gray-700 cursor-pointer">
