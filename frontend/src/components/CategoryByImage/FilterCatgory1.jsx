        ...
        >
          ...
          >
            <Image
              ...
              alt={category?.category?.SubCategoryName || "Category"}
              width={400}
              height={250}
            ...
            <div className="absolute bottom-0 w-full flex items-center justify-center pb-2">
              <button className="yellow-bg hover:bg-purple-800 cursor-pointer text-white font-medium px-4 py-2 rounded-full inline-flex items-center gap-2 transition ">
