...
import { ChevronsLeft, ChevronsRight, Heart, ShoppingCart, Filter } from "lucide-react";
...
const Shop = () => {
  ...
  if (!hydrated) {
    return null; // render nothing until client-side hydration finishes
  }
      ...
      <div className="max-w-7xl mx-auto px-4 py-4">
        <div className="lg:hidden flex justify-end mb-4">
          <button
            ...
            className="flex items-center gap-2 text-indigo-600 border border-indigo-600 px-3 py-1.5 cursor-pointer text-sm rounded-md"
          >
            <Filter size={16} />
            Filters
          </button>
      ...
      <div className="max-w-6xl mx-auto py-6 overflow-auto">
        <div className="flex justify-center space-x-2 mt-4">
          ...
          <button
            ...
            className={`px-4 py-1 flex items-center border cursor-pointer rounded-full ${
