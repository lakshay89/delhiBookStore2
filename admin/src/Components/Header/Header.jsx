...
const Header = () => {
  ...
  const navItems = [
    ...
    { to: "/all-maincategory", label: "All Main Category", icon: "fa-solid fa-sitemap", },
    { to: "/all-category", label: "All Category", icon: "fa-solid fa-layer-group", },
    { to: "/all-sub-category", label: "All Sub Category", icon: "fa-solid fa-th-large", },
    { to: "/all-products", label: "All Products", icon: "fa-solid fa-cubes" },
     { to: "/all-banners", label: "Manage Banners", icon: "fa-solid fa-images" },
    { to: "/all-level-images", label: "All Level Images", icon: "	fa-solid fa-signal", },
    ...
    { to: "/all-shipping-cost", label: "All Shipping Costs", icon: "fa-solid fa-box" },
    { to: "/all-delivery-partners", label: "Delivery Partners", icon: "fa-solid fa-people-carry-box" },
    ...
    { to: "/all-country-currency", label: "All Country Currency", icon: "fa-solid fa-envelope-open-text", },
    { to: "/all-setting", label: "Setting", icon: "fa-solid fa-envelope-open-text", },
  ...
  return (
    <header>
      <div className="top-head">
        ...
        <div className="left">
          <a href="https://delhibookstore.com/" target="_blank" rel="noopener noreferrer">
