...
const EditProduct = () => {
  ...
  const fetchProductDetails = async (id) => {
    try {
      ...
      if (res?.data) {
        ...
        const categoryId = res.data.product?.category?._id;
        ...
        if (categoryId) {
          const subCategoryRes = await axiosInstance.get(
            `/api/v1/subcategory/get-subcategories-by-category/${categoryId}`
          );
  ...
  const handleCategoryChange = async (e) => {
    ...
    try {
      const res = await axiosInstance.get(
        `/api/v1/subcategory/get-subcategories-by-category/${value}`
      );
      ...
      <div className="d-form">
        <form className="row g-3 mt-2" onSubmit={handleSubmit}>
          ...
          <div className="row">
            ...
            <div className="col-md-2">
              <label className="form-label">Final Price (USD)*</label>
              <input
                type="number"
                name="finalPrice"
                className="form-control"
